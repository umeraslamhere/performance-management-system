...
class __TwigTemplate_57cf9ec7c21c7f681ec9ccd0d73be26fc37ced15fed612251d10a81d424ff84b extends Template
{
    private $source;
    private $macros = [];
    ...
    <h5>";
        // line 9
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 9, $this->source); })()), "body", [], "any", false, false, false, 9), "html", null, true);
        echo "</h5>
    <hr>
    <a href=\"/\">Go Back</a>
...
";
    ...
    {
        return array (  97 => 9,  93 => 8,  90 => 7,  80 => 6,  59 => 3,  36 => 1,);
    }
...
", "articles/show.html.twig", "/home/coeus/Desktop/performance_management_product/templates/articles/show.html.twig");
    }
}
