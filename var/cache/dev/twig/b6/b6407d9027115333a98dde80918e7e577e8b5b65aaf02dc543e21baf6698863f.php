...
class __TwigTemplate_d4fe5691b6bfd2cc5dfe937d67417c8f1635f9757504b10a2787864fa78376ba extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 12, $this->source); })()), "roles", [], "any", false, false, false, 12));
    ...
    <a href=\"/admin/signup_requests\">Go Back</a>
...
";
    ...
    {
        return array (  120 => 16,  116 => 14,  107 => 13,  103 => 12,  97 => 9,  93 => 8,  90 => 7,  80 => 6,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    {% endfor %}    
    <hr>
    <a href=\"/request/update/{{user.id}}\" class=\"btn btn-primary\">Update</a>
    <a href=\"/admin/signup_requests\">Go Back</a>

{% endblock %}
", "admin/users/show.html.twig", "/home/coeus/Desktop/performance_management_product/templates/admin/users/show.html.twig");
    }
}
